...
namespace lear {
    struct DetectInfo {
        ...
        DetectInfo(
                ...
                const IndexType l, const IndexType e, const IndexType olb=0, const bool hardtest=false):
            score(score), scale(scale), lbound(l), extent(e), orig_lbound(olb), hardtest(hardtest)
        {}
