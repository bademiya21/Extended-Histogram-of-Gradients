...
class RHOGDense {
    ...
    typedef lear::PrecisionHistogram<RealType,RealType,3>    
                                                    HistogramType;
	typedef lear::DiscreteHistogram<RealType,RealType,3>    
                                                    HistogramType1;
	...
	typedef HistogramType1::HistElementType          ElemType1;

    /// feature array type
    typedef HistogramType::HistType                 FeatType1;
	typedef HistogramType1::HistType                 FeatType;

    /// feature vector array index type
    typedef HistogramType::IndexType                FeatIndexType;
	typedef HistogramType1::IndexType                FeatIndexType1;
	...
	const DescNormalizer<RealType>* normalizer1;
    ...
    blitz::TinyVector<RealType,3>   h_extent, h_bandwidth, h_extent1, h_bandwidth1;

    /// temp array to save filter response
    mutable Preprocessor::MagAType tmag_;

    mutable HistogramType hist_;
	mutable HistogramType1 hist1_;
